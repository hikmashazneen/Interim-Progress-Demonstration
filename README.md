# A Personalised Data-Driven Approach to Predicting Brain Tumour Survivability in Adult Patients in Sri Lanka
...
## Features
- Data preprocessing and cleaning pipeline for structured clinical data  
- Survival analysis using multiple machine learning models  
- Risk stratification  
- Interactive dashboard for visualisation and exploration  

## Dataset
The dataset used is not included. It contains anonymised records of Sri Lankan brain tumour patients (2018–2022). 
